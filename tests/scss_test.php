...
/**
 * This file contains the unittests for ilb's scss compilation.
 *
 * @package   theme_ilb
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_ilb_scss_testcase extends advanced_testcase {
    /**
    ...
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('ilb')->get_css_content_debug('scss', null, null)
        );
    }
}
