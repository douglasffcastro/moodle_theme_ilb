	...
	<div id="topo">
		...
		<div id="topoPortal">
			...
			<a href="http://www.senado.gov.br/" title="Volta para a p&aacute;gina inicial." class="logo"><img src="<?php echo $OUTPUT->pix_url('logo-senado-pb', 'theme')?>" alt="Volta para a p&aacute;gina inicial"/></a>
