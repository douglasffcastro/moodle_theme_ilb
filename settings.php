...
if ($ADMIN->fulltree) {                                                                                                             
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingilb', get_string('configtitle', 'theme_ilb'));             
    ...
    $setting = new admin_setting_configtextarea('theme_ilb/scsspre',                                                              
        get_string('rawscsspre', 'theme_ilb'), get_string('rawscsspre_desc', 'theme_ilb'), '', PARAM_RAW);                      
    $setting->set_updatedcallback('theme_reset_all_caches');                                                                        
    $page->add($setting);                                                                                                           
 
    // Raw SCSS to include after the content.                                                                                       
    $setting = new admin_setting_configtextarea('theme_ilb/scss', get_string('rawscss', 'theme_ilb'),                           
